...
(function() {
  ...
  Game = (function() {
      ...
      return this.board = (function() {
        ...
        for (x = _i = 0; 0 <= WIDTH ? _i < WIDTH : _i > WIDTH; x = 0 <= WIDTH ? ++_i : --_i) {
          _results.push((function() {
            ...
            _results1 = [];
            for (y = _j = 0; 0 <= HEIGHT ? _j < HEIGHT : _j > HEIGHT; y = 0 <= HEIGHT ? ++_j : --_j) {
              _results1.push(this.random_cell());
            }
            return _results1;
          }).call(this));
        }
    ...
    Game.prototype.neighbour_count = function(x, y) {
      var cur_x, cur_y, i, j, result, _i, _j, _len, _len1;
      result = 0;
      for (_i = 0, _len = SURROUND.length; _i < _len; _i++) {
        i = SURROUND[_i];
        cur_x = x + i;
        for (_j = 0, _len1 = SURROUND.length; _j < _len1; _j++) {
          j = SURROUND[_j];
          cur_y = y + j;
    ...
    Game.prototype.new_board = function() {
      ...
      for (x = _i = 0; 0 <= WIDTH ? _i < WIDTH : _i > WIDTH; x = 0 <= WIDTH ? ++_i : --_i) {
        _results.push((function() {
          ...
          _results1 = [];
          for (y = _j = 0; 0 <= HEIGHT ? _j < HEIGHT : _j > HEIGHT; y = 0 <= HEIGHT ? ++_j : --_j) {
            _results1.push(this.should_live(x, y));
          }
          return _results1;
        }).call(this));
      }
